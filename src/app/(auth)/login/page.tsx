...
const errorMessages: Record<string, string> = {
  ...
  CredentialsSignin: '이메일을 확인해 주세요. (회사 도메인이 아닙니다)',
  ...
  return (
    <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
      ...
      >
        ...
        <button
          type="submit"
          className="w-full px-4 py-2.5 bg-indigo-600 text-white rounded-lg font-medium text-sm hover:bg-indigo-700 transition-colors"
        >
          로그인
        </button>
      </form>
